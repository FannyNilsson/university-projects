...
uniform vec3 u_lightAmbientIntensity = vec3(0.6, 0.6, 0.6);
uniform vec3 u_lightDiffuseIntensity = vec3(0.5, 0.5, 0.5);
uniform vec3 u_lightSpecularIntensity = vec3(0.5, 0.5, 0.5);
